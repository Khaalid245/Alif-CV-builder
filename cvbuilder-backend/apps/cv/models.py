...
class Announcement(models.Model):
    """
    Admin announcements displayed to students on the dashboard.
    Only the latest active announcement is shown.
    """
    id         = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    message    = models.TextField(max_length=500, help_text='Announcement message to display')
